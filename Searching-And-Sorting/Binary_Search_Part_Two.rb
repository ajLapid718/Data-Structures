...
In keeping with the theme of a phonebook search or dictionary search, the potential_index is established as the midpoint of the array.

The switch statement makes for a cleaner setup, but the focal point here is spaceship operator.
...
This means that the target_element was found and so we return the midpoint.
